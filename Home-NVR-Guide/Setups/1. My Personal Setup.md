...
# My Future Plans
- Eventually, I'd like to include indoor cameras in this setup in high traffic rooms and hallways for extra security.
- I'd like to setup a cloud storage solution that backs up my recorded Frigate videos to a cloud spot. I *sort of* have this already, I backup my FrigateNVR setup weekly to a google cloud location, but recovering the video files only from that is not really feesable and I'd have to do a full restore just to get the files.
- Home assistant is a hobby of mine, so I'm sure (much to my wife's chagrin) that I'll come up with more additional features to this over time!
